...
## File: src/main/java/com/videoclub/apigateway/ApigatewayApplication.java
```java
...
## File: src/test/java/com/videoclub/apigateway/ApigatewayApplicationTests.java
```java
package com.videoclub.apigateway;
